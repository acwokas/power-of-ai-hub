                ...
                <Tooltip key={index}>
                  <TooltipTrigger asChild>
                    ...
                    >
                      {/* Logo */}
                      <div 
                        className={`w-40 h-28 flex items-center justify-center rounded-lg border-2 shadow-lg transition-all duration-300 group-hover:shadow-xl group-hover:scale-105 group-hover:border-[#00B3FF] ${
                          link.alt === "BusinessInAByte logo" ? 'p-3' : 
                          link.alt === "PromptAndGo logo" ? 'p-1' : 
                          'p-0'
                        }`}
                        style={{ 
                      ...
                      <div className="text-center">
                        <div className="text-sm font-medium inline-flex items-center gap-1" style={{ color: '#00B3FF' }}>
                          {link.subdomain}
