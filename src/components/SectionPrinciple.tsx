const SectionPrinciple = () => {
  return (
    <section id="principle" className="py-20 md:py-28 bg-background border-t border-border/60">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid md:grid-cols-12 gap-10 md:gap-16">
          ...
          <div className="md:col-span-8 md:col-start-6 space-y-5 text-lg md:text-xl text-foreground/85 leading-relaxed">
            ...
            <p>When used properly, AI changes that.</p>

            <p>Not by replacing expertise.</p>
...
export default SectionPrinciple;
